<footer class="main-footer">
    <strong>Copyright &copy; 2023 HALLYNIME RETREAT.</strong>
    All rights reserved.
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="text-center" style="margin-top: 10px;">
      <img class="profile-user-img img-fluid img-circle" src="<?= base_url(); ?>assets/images/user.png" alt="User profile picture">
    </div>
    <h3 class="profile-username text-center"><?= $this->session->userdata("login_data_admin_hr")['nama'] ?></h3>
    <p class="text-muted text-center"><?= $this->session->userdata("login_data_admin_hr")['role'] ?></p>
